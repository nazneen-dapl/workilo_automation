...
WebUI.click(findTestObject('Object Repository/MarkServiceComplete/AcceptedOrderDetail'))
WebUI.click(findTestObject('Object Repository/MarkServiceComplete/AcceptedOrderList'))
...
WebUI.click(findTestObject('Object Repository/MarkServiceComplete/ServiceCompleteButton'))

//WebUI.click(findTestObject('Object Repository/AcceptBookingOrder/button_Accept'))
WebUI.click(findTestObject('Object Repository/MarkServiceComplete/ConfirmCompleteButton'))
